...
<section class="advantages advantages--mod">
	<div class="container">
		...
		<a href="l#" class="btn btn--green btn--padd advantages_btn">заполнить анкету для сотрудничества</a>
	</div>
</section>


		<!-- TODO Модальное окно - Анкета для партнеров -->
<div class="modal modal-partners">
	<div class="modal_wrapper">
		<div class="modal_container">
			<a href="partners.html#" class="modal_close js-close-modal">Закрыть окно</a>
			<form onsubmit="return sendPartnerForm();">
