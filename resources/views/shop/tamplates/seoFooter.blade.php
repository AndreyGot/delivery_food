		<article class="seo-footer">
			<div class="container">
				<h1>123 доставка еды на дом!</h1>
<p>Любые блюда из лучших ресторанов города прямо у вас дома, вы можете заказать еду с 123! Это так удобно и просто, всего три простых шага:</p>
<ul>
...
<p>Наш сервис предлагает специальные программы для постоянных клиентов, а также непрерывно отслеживает различные акции и скидки. Потому вы сможете ловить самые выгодные предложения! Мы работаем с душой и даем людям не только возможность заказать еду, но и получить положительные эмоции. Готовьтесь получать сюрпризы, подарки и приятные мелочи, которые сделают работу с сайтом веселым приключением! Fast-Delivery ждет ваших заказов!</p>
			</div>
		</article>